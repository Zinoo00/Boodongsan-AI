...
class RAGServiceError(BaseAppException):
    ...
    def __init__(
        self, message: str, stage: str | None = None, user_id: str | None = None, **kwargs
    ):
        details = kwargs.pop("details", {})
        if stage:
            details["stage"] = stage
...
class ValidationError(BaseAppException):
    ...
    def __init__(
        self, message: str, field_name: str | None = None, field_value: Any | None = None, **kwargs
    ):
        details = kwargs.pop("details", {})
        if field_name:
            details["field_name"] = field_name
...
class UserError(BaseAppException):
    ...
    def __init__(self, message: str, user_id: str | None = None, **kwargs):
        details = kwargs.pop("details", {})
        if user_id:
            details["user_id"] = user_id
...
class PropertyError(BaseAppException):
    ...
    def __init__(self, message: str, property_id: str | None = None, **kwargs):
        details = kwargs.pop("details", {})
        if property_id:
...
class PolicyError(BaseAppException):
    ...
    def __init__(self, message: str, policy_id: str | None = None, **kwargs):
        details = kwargs.pop("details", {})
        if policy_id:
    ...
    def decorator(func):
        def wrapper(*args, **kwargs):
            try:
                ...
                raise DatabaseError(
                    message=f"Database operation failed: {operation}", operation=operation, cause=e
                )
